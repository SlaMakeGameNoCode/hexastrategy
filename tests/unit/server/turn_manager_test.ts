...
import { TurnManager, PlayerTurnPayload } from '../../../src/server/turn-manager.js';
...
describe('TurnManager Unit Tests', () => {
  ...
  it('test_valid_ap_payload_is_accepted', () => {
    const payload: PlayerTurnPayload = {
      playerId: 'player1',
      round: 1,
      actions: [
  ...
  it('test_exceeding_10_ap_payload_is_rejected', () => {
    const invalidPayload: PlayerTurnPayload = {
      playerId: 'player1',
      round: 1,
      actions: [
        { unitId: 'u1', type: 'MOVE', actionCost: 3 },
  ...
  it('test_has_both_submitted_returns_true_when_p1_and_p2_submit', () => {
    const p1Payload: PlayerTurnPayload = {
      playerId: 'p1',
      round: 1,
      actions: [{ unitId: 'u1', type: 'MOVE', actionCost: 2 }]
    };
    const p2Payload: PlayerTurnPayload = {
      playerId: 'p2',
      round: 1,
