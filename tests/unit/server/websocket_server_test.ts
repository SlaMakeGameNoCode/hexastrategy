...
import { createGameServer, GameServerInstance } from '../../../src/server/server.js';
import { RoomManager, PlayerSession } from '../../../src/server/room-manager.js';
...
describe('WebSocket Server & Room Manager Unit Tests', () => {
  ...
  it('test_room_manager_pairs_two_players_into_match', () => {
    ...
    const player1: PlayerSession = { id: 'p1', socket: {}, joinedAt: Date.now(), disconnectedTurns: 0 };
    const player2: PlayerSession = { id: 'p2', socket: {}, joinedAt: Date.now(), disconnectedTurns: 0 };
