...
describe('Charge vs Brace Counter Unit Tests', () => {
    it('test_brace_triggers_counter_damage_and_cancels_charge', () => {
        ...
        const result = CombatResolver.calculateDamage('HEAVY_CAVALRY', 'LONG_SPEAR', true, // isAttackerCharging
    ...
    it('test_charge_without_brace_deals_bonus_damage', () => {
        ...
        const normalCharge = CombatResolver.calculateDamage('HEAVY_CAVALRY', 'SWORD_SHIELD', true, // isAttackerCharging
        false // isDefenderBracing
        );
        const normalAttack = CombatResolver.calculateDamage('HEAVY_CAVALRY', 'SWORD_SHIELD', false, // isAttackerCharging
        false // isDefenderBracing
        );
